...
export default function Newsletter() {
  ...
  return (
    <section ref={ref} id="subscribe" className="py-20 md:py-28 bg-white">
      <div className="max-w-[1200px] mx-auto px-6">
        <div ref={contentRef} className="text-center max-w-2xl mx-auto">
          <h2 className="text-[36px] md:text-[48px] font-medium text-[#191C1F] leading-[1.1] tracking-[-0.02em] mb-4">
            Join the 10 million+<br />reading FlavorNews
          </h2>
          <p className="text-[17px] text-[#8D969E] leading-relaxed mb-10">
            Get the most important stories delivered to your inbox. Trusted by millions worldwide.
          </p>
          ...
          <p className="text-[13px] text-[#8D969E] mt-4">
