            ...
            <div className="flex items-center gap-2 mt-6">
              {SOCIALS.map((s) => (
                <a key={s.name} href={s.href} aria-label={s.name}
                  className="w-9 h-9 rounded-full bg-white/5 hover:bg-white/10 flex items-center justify-center text-[#8D969E] hover:text-white transition-all duration-300">
                  {s.icon}
                </a>
              ))}
            </div>
        ...
        <div className="pt-8 border-t border-white/5">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4 mb-6">
            ...
            <div className="flex items-center gap-4">
              {SOCIALS.map(s => (
                <a key={s.name} href={s.href} className="text-[13px] text-[#8D969E] hover:text-white transition-colors">
                  {s.name}
                </a>
              ))}
            </div>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="flex flex-wrap items-center gap-4">
              {['Website Terms', 'Legal', 'Privacy', 'Cookie Settings', 'Accessibility'].map(link => (
